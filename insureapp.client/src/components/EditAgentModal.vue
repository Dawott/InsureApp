...
export default {
  ...
  setup(props, { emit }) {
    const formData = ref({
      ...
      licence: props.agent.licence || '',
      isActive: props.agent.isActive,
      passwordHash: props.agent.passwordHash
    });
    ...
    const handleSubmit = async () => {
      try {
        ...
        const response = await agentsService.updateAgent(props.agent.id, formData.value);
        ...
        error.value = 'Błąd w update agenta.';
